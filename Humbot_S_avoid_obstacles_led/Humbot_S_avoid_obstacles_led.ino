...
//###########################################################################
#define TOO_CLOSE 1000  //Distance at which the robot will turn
...
//###########################################################################
    ...
    if (distance < 1500){        //Distance where the led colour is changed
    writeleds(155,0,0);}       //red led
    else if (distance < 2000){   //Distance where the led colour is changed to the next colour
