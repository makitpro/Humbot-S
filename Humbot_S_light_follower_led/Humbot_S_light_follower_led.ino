...
//###########################################################################
    ...
    and we can combine them. In the example the led is green.*/
   writeleds(0,155,0); //default color (green)
//###########################################################################
//###########################################################################
//---End of LED extra siren--------------------  
}
...
//---Start of LED extra siren------------------   
  void writeleds(int red, int green, int blue){
   digitalWrite(REDled_pin, red); //write red left led
   digitalWrite(GREENled_pin, green); //write green left led
   digitalWrite(BLUEled_pin, blue); //write blue left led
   }
//---End of LED extra siren--------------------     
